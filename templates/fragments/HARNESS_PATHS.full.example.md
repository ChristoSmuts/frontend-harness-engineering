...
- **Canonical skills:** `{{CANONICAL_SKILLS_DIR}}/` — edit here; run `scripts/sync-skills.sh --all-mirrors` after changes
...
- **Canonical skills:** `.agents/skills/` — edit here; run `scripts/sync-skills.sh --all-mirrors` after changes
- **Shared entry:** `AGENTS.md` (this file)
