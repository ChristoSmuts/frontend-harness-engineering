...
- **Canonical skills:** `.cursor/skills/` — edit here; run `.agent-scripts/sync-skills.sh` after skill edits
...
- **Cursor:** rules `.cursor/rules/`, hooks `.cursor/hooks.json`, skills `.cursor/skills/`
